<template>
  <div class="favorite-circle" @click.stop="toggleFavorite(pokemon)">
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path :class="isFavorite ? 'favorite' : 'not-favorite'"
...
<script>
import '@/styles/components/ui/favoriteButton.scss';
...
export default {
  ...
  methods: {
    ...mapActions('pokemon', ['toggleFavorite']),
  }
}
</script>